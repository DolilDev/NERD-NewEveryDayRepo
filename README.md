...
| :----: | ----- | ----------- | ----- | ------ |
| ⏳ | NERD-graphql-api-server | Build a GraphQL API server using Node. js and TypeScript. The project should be structured into several layers: 1. | — | [NERD-graphql-api-server](./NERD-graphql-api-server) |
...
| ✅ | Personal Finance Tracker App | Create a Personal Finance Tracker App that allows users to manage their income and expenses. | Node.js, TypeScript, Python, JavaScript | [NERD-personal-finance-tracker](./NERD-personal-finance-tracker) |
